...
namespace Dvchevskii.Blog.Infrastructure.Migrations
{
    ...
    [Migration("20241105124437_v004_add_user_avatarid")]
    partial class v004_add_user_avatarid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dvchevskii.Blog.Core.Files.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dvchevskii.Blog.Core.Posts.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dvchevskii.Blog.Core.Authentication.Users.User", b =>
                {
                    b.HasOne("Dvchevskii.Blog.Core.Files.Image", "Avatar")
                        .WithMany()
            ...
            modelBuilder.Entity("Dvchevskii.Blog.Core.Posts.Post", b =>
                {
                    b.HasOne("Dvchevskii.Blog.Core.Files.Image", "HeaderImage")
                        .WithMany()
