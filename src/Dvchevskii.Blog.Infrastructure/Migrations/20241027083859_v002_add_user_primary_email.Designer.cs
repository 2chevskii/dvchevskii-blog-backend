...
namespace Dvchevskii.Blog.Infrastructure.Migrations
{
    ...
    [Migration("20241027083859_v002_add_user_primary_email")]
    partial class v002_add_user_primary_email
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dvchevskii.Blog.Core.Authentication.Tokens.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dvchevskii.Blog.Core.Authentication.Tokens.RefreshToken", b =>
                {
                    b.HasOne("Dvchevskii.Blog.Core.Authentication.Users.User", "User")
                        .WithMany()
